...
export function FlightHUD() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-4 top-12 flex flex-col gap-2 rounded-lg border border-white/10 bg-black/40 px-3 py-2 text-[11px] uppercase tracking-widest text-cyan-100/90 backdrop-blur">
      ...
      {/* top-right: battery arc + mode */}
      <div className="absolute right-4 top-12 flex flex-col items-end gap-2 rounded-lg border border-white/10 bg-black/40 px-3 py-2 text-[11px] uppercase tracking-widest backdrop-blur">
      ...
      <div className="absolute bottom-16 left-1/2 -translate-x-1/2 rounded-full border border-white/10 bg-black/40 px-4 py-2 backdrop-blur">
        <div
